...
Allocated: `0x05`, `0x06`, `0x07` (FTS), `0x10` (parts), `0x11` (locations), `0x12` (via), `0xF0` (meta).

Free ranges: `0x00-0x04`, `0x08-0x0F`, `0x13-0xEF`, `0xF1-0xFF`. A new prefix picks a free
